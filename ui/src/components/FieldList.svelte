<script lang="ts">
    ...
    serverSideDatasource = {
      getRows: async (params) => {
        ...
        try {
          ...
          console.error('FieldList SSRM error:', error);
          params.fail();
        } finally {
          loading = false;
        }
  ...
  function handleRowSelection(event: any) {
    ...
    if (selectedRows.length > 0) {
      console.log('Selected field:', selectedRows[0]);
      // TODO: Implement field detail view or navigation
    }
  }
</script>
